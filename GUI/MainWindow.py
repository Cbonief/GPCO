...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphWidget.setGeometry(QtCore.QRect(370, 450, 360, 280))
        self.graphWidget.setMinimumSize(QtCore.QSize(360, 280))
        self.graphWidget.setObjectName("graphWidget")
        self.label_4 = QtWidgets.QLabel(self.graphWidget)
        self.label_4.setEnabled(True)
        self.label_4.setGeometry(QtCore.QRect(0, 0, 351, 211))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 10, 301, 731))
        ...
        self.layoutWidget1 = QtWidgets.QWidget(self.FullOptimizerTab)
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 0, 299, 253))
        ...
        self.layoutWidget_2 = QtWidgets.QWidget(self.NumericOptimizerTab)
        self.layoutWidget_2.setGeometry(QtCore.QRect(0, 0, 299, 253))
        ...
        self.pushButtonSelC1.setMinimumSize(QtCore.QSize(20, 25))
        self.pushButtonSelC1.setMaximumSize(QtCore.QSize(120, 25))
        self.pushButtonSelC1.setObjectName("pushButtonSelC1")
        self.horizontalLayout_20.addWidget(self.pushButtonSelC1)
        ...
        self.pushButtonSelC2.setMinimumSize(QtCore.QSize(20, 25))
        self.pushButtonSelC2.setMaximumSize(QtCore.QSize(120, 25))
        self.pushButtonSelC2.setObjectName("pushButtonSelC2")
        self.horizontalLayout_20.addWidget(self.pushButtonSelC2)
        ...
        self.pushButtonSelC3.setMinimumSize(QtCore.QSize(20, 25))
        ...
        self.pushButtonSelC4.setMinimumSize(QtCore.QSize(20, 25))
        ...
        self.optimize_button.setGeometry(QtCore.QRect(130, 740, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_ConfiguracoesDoOtimizador_3.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt;\">Parâmetros de Projeto</span></p></body></html>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.FullOptimizerTab), _translate("MainWindow", "Otimização Completa"))
        self.label_ConfiguracoesDoOtimizador_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Escolha dos Componentes</span></p></body></html>"))
