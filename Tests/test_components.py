...
NEE_30_15 = Core(1.037e-8, 1.22e-4, 0.85e-4, 8.17e-6, 7.9292e-3, 1.4017, 2.3294, 6.7e-2, 17.2e-3,
                 Name='NEE_30_15')  # Transformador
...
NEE_30_15_Ideal = Core(1.037e-8, 1.22e-4, 0.85e-4, 8.17e-6, 0, 1.4017, 2.3294, 6.7e-2, 17.2e-3,
                       Name='NEE_30_15_Ideal')  # Transformador
NEE_42_20_Ideal = Core(3.77e-8, 2.4e-4, 1.57e-4, 23.3e-6, 0, 1.4017, 2.3294, 8.7e-2, 25.9e-3,
                       Name='NEE_42_20_Ideal')  # Li

# Cria os cabos.
AWG_23 = Cable(0.5753e-3, 0.5733e-3, 1.68e-8, 0.999994, Name='AWG_23')
IdealCable = Cable(0.5753e-3, 0.5733e-3, 0, 0.999994, Name='IdealCable')
...
# Cria os capacitores.
capacitor1 = Capacitor(125e-6, 31e-3 / 3, 55, Name='C1')
capacitor2 = Capacitor(330e-6, 30e-4, 55, Name='C2')
...
carolina_converter = BoostHalfBridgeInverter(design_features, safety_params, Trafo, Li, Lk, switches, diodes,
                                             capacitors)
